package com.example.potatodiseasemobileapp.ml;
...
public final class Output20 {
  @NonNull
  private final Model model;

  private Output20(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "output20.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static Output20 newInstance(@NonNull Context context) throws IOException {
    return new Output20(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static Output20 newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new Output20(context, options);
  }
